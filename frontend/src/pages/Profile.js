        ...
        <div className="space-y-4">
          <div className="bg-white p-6 rounded-lg border border-slate-200 shadow-sm">
            ...
            <p className="text-slate-600 leading-relaxed mb-2">
              <strong>Banka ki Awaaz | Bihar ka Vishwasniya News Portal</strong>
            </p>
            <p className="text-slate-600 leading-relaxed">
              Your trusted source for local news from Banka and Bihar. Stay updated with the latest stories, events, and developments in your community.
            </p>
          </div>
